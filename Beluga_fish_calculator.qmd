...
You can modify the above equation using this calculator to see how the number of fish needed per day changes as the mass of the whale and calories of the fish change. The default values observed here are the average mass of the adult female beluga whales included in [@john2024] and the average calories in a Chinook salmon as described by [@oneill2014]. Adult female beluga whales can typically weigh between 680-1179kg and males can typically be found between 1088-1587kg.
